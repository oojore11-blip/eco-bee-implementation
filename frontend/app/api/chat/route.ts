      ...
      return NextResponse.json(
        {
          ...
          response:
            "I'm sorry, but I'm not properly configured to provide responses right now. Please check back later.",
        },
        { status: 500 }
      );
    }

    // Call Mistral API using server-side environment variables
    try {
        ...
        "https://api.mistral.ai/v1/chat/completions",
        {
          ...
          body: JSON.stringify({
            ...
            messages: [
              {
                role: "system",
                content: `You are EcoBee, a friendly sustainability assistant. Help users with environmental questions and provide practical eco-friendly advice. Keep responses concise and actionable. Context: ${
                  context || "general sustainability advice"
                }`,
              },
              {
                role: "user",
